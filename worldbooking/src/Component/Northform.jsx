        ...
        <section id="asiasec">
          ...
          <form action="" onSubmit={detailsubmit}>
            ...
            <div>
              ...
              <input type="number" name="price" value={4000} readOnly onChange={instdetail} style={{marginLeft:"19px"}} />
            ...
            <select name="country" id="asiaoption" onChange={instdetail} >
              ...
              <option value="North Am. - India">    North Am. - India</option>
              <option value="North Am. - China">    North Am. - China</option>
              <option value="North Am. - Iraq">     North Am. - Iraq</option>
              <option value="North Am. - Sri Lanka">North Am. - Sri Lanka</option>
            </select>

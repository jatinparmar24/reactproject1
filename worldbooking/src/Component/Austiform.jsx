  ...
  function instdetail(e){
    ...
    return(
        ...
        <section id="asiasec">
            ...
            <h1 className="asiafromhead">Australia Continent</h1>
          ...
          <form action="" onSubmit={detailsubmit}>
            ...
            <div>
              ...
              <input type="number" name="price" value={6000} readOnly onChange={instdetail} style={{marginLeft:"19px"}} />
            ...
            <select name="country" id="asiaoption" onChange={instdetail} >
              ...
              <option value="Australia - Iraq">     Australia - Iraq</option>
              <option value="Australia - Sri Lanka">Australia - Sri Lanka</option>
            </select>

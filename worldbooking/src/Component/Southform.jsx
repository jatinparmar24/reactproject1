        ...
        <section id="asiasec">
          ...
          <form action="" onSubmit={detailsubmit}>
            ...
            <div>
              ...
              <input type="number" name="price" value={5000} readOnly onChange={instdetail} style={{marginLeft:"19px"}} />
            ...
            <select name="country" id="asiaoption" onChange={instdetail} >
              ...
              <option value="South Am. - India">    South Am. - India</option>
              <option value="South Am. - China">    South Am. - China</option>
              <option value="South Am. - Iraq">     South Am. - Iraq</option>
              <option value="South Am. - Sri Lanka">South Am. - Sri Lanka</option>
            </select>

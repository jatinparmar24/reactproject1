        ...
        <section id="asiasec">
          ...
          <form action="" onSubmit={detailsubmit}>
            ...
            <select name="country" id="asiaoption" onChange={instdetail} >
              ...
              <option value="Europe - India">    Europe - India</option>
              <option value="Europe - China">    Europe - China</option>
              <option value="Europe - Iraq">     Europe - Iraq</option>
              <option value="Europe - Sri Lanka">Europe - Sri Lanka</option>
            </select>
